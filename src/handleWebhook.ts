import { placePosition } from "./utils";

const pricePrecision: any = {
  BTCUSDT: 1,
  BNBUSDT: 2,
  ETHUSDT: 2,
  XRPUSDT: 4,
  ...
  try {
    ...
    if (alert.strategy.strategy_action === "entry") {
      ...
      if (take_profit_price) {
        ...
        console.log("---Place Position Starting---");
        console.log("options", tp_options);
        placePosition();
        console.log("---Place Position successful---");
      }
